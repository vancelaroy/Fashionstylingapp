...
export function AuthScreen({ onAuth }: AuthScreenProps) {
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: "var(--background)", fontFamily: "var(--font-body)" }}>
      {/* Editorial header */}
      <div
        className="flex flex-col items-center justify-center pt-20 pb-12 px-8"
        style={{ background: "linear-gradient(180deg, rgba(201,169,110,0.06) 0%, transparent 100%)", borderBottom: "1px solid var(--border)" }}
      >
        <p style={{ color: "var(--gold)", fontSize: "10px", letterSpacing: "0.25em", textTransform: "uppercase", fontWeight: 500, marginBottom: 12 }}>
          Personal Styling
        </p>
        <h1 style={{ fontFamily: "var(--font-display)", color: "var(--cream)", fontSize: "52px", fontWeight: 400, letterSpacing: "-0.04em", lineHeight: 1, fontStyle: "italic", marginBottom: 8 }}>
          IRYS
        </h1>
      ...
      <div className="flex-1 flex flex-col px-6 pt-8 pb-10">
        {/* Mode toggle */}
        <div className="flex rounded-xl p-1 mb-8" style={{ background: "var(--surface)" }}>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-2xl flex items-center justify-center gap-3 mb-6 transition-all active:scale-95"
        ...
        <button
          ...
          disabled={isDisabled}
          className="mt-8 w-full py-4 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-95"
          style={{
        ...
        <p style={{ color: "var(--muted-foreground)", fontSize: "11px", textAlign: "center", marginTop: 16, lineHeight: 1.6 }}>
